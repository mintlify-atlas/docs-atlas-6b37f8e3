...
<ParamField path="split_reports" type="boolean" default="false">
...
<ParamField path="ramdisk" type="boolean" default="false">
...
This is the canonical configuration template shipped with AFL Runner (`AFLR_CFG_TEMPL.toml`). Every supported key is present and annotated.
